...
{
    public class VerifyLocationSift
    {
        ...
        private static String run_verify_location_module(String base_photo_path, String current_photo_path, Double ratio)
        {
            ...
            String myPythonApp = "sift.py " + base_photo_path + " " + current_photo_path + " " + ratio;

            Logger.getInstance().info("sift verify location params are: " + myPythonApp);
