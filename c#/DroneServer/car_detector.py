...
copyfile(cwd + '\\' + base_photo_name , cwd2 + '\\' + base_photo_name)


p = subprocess.Popen(args=['darknet_no_gpu.exe','detect','yolov3-aerial.cfg','yolov3-aerial.weights','cfg/coco.data', base_photo_name], cwd=cwd2, shell=True)
p.communicate()